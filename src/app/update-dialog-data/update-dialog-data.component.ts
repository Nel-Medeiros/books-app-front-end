...
@Component({
  selector: 'app-update-dialog-data',
  templateUrl: './update-dialog-data.component.html',
  styleUrls: ['./update-dialog-data.component.css']
})
export class UpdateDialogDataComponent implements OnInit {

  bookForm: FormGroup;

  constructor(@Inject(MAT_DIALOG_DATA) public data: Book, public dialogRef: MatDialogRef<UpdateDialogDataComponent>, private formBuilder: FormBuilder, private booksService: BooksService, private router: Router) { }

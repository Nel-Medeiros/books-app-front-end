...
@Component({
  selector: 'app-add-book-dialog-data',
  templateUrl: './add-book-dialog-data.component.html',
  styleUrls: ['./add-book-dialog-data.component.css']
})
export class AddBookDialogDataComponent implements OnInit {

  bookForm: FormGroup;

  constructor(@Inject(MAT_DIALOG_DATA) public data: Book, public dialogRef: MatDialogRef<AddBookDialogDataComponent>, private formBuilder: FormBuilder, private booksService: BooksService, private router: Router) { }
